    ...
    <>
      <div>
        <div className="relative">
          ...
          {isPopUpOpen && (
            <div className="absolute top-10 right-1 flex flex-col items-end" ref={popupRef}>
              <div className="[clip-path:polygon(50%_0%,0%_100%,100%_100%)] bg-gray-100 w-6 h-9 -mb-2 mr-2"></div>
              <div className="h-80 w-80 bg-gray-100 rounded-md overflow-scroll p-3">
                <div className="">
                                    ...
                                    {synonyms?.length !== 0 && (
                                      <div className="my-2">
                                        ...
                                        <div className="flex flex-wrap gap-3">
                                          {synonyms?.map((item) => (
                                            <p
                                              className="bg-orange-200 px-2 py-0.5 text-xs"
                                              key={item}
                                            >
                                              {item}
                                            </p>
